...
This autocmd (idea from [[https://github.com/junegunn/dotfiles/blob/5485496191a5413b9bf073ea0660ed97ccefc53d/vimrc#L1765][a snippet from junegunn's dotfiles]], found via [[https://github.com/arzg/vim-tabhelp][this plugin]]) has help buffers cover the whole viewpane and enables using just q to exit from them.
#+BEGIN_SRC org
